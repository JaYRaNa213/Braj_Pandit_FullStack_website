...
const About = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-4xl font-bold text-[#4A1C1C] mb-6 text-center">About Us</h1>
      ...
      <h2 className="text-2xl font-semibold text-red-700 mt-8 mb-4">🌟 Our Mission</h2>
      ...
      <h2 className="text-2xl font-semibold text-red-700 mt-8 mb-4">👨‍💻 Founder</h2>
      <p className="text-gray-700 text-justify">
      ...
      <h2 className="text-2xl font-semibold text-red-700 mt-8 mb-4">🤝 Our Vision</h2>
