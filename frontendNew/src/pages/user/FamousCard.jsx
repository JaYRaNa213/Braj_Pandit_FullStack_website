...
const FamousCard = ({ place }) => {
  return (
    <div className="w-full bg-white rounded-xl shadow-lg hover:shadow-2xl flex flex-col md:flex-row overflow-hidden min-h-[220px] border border-orange-100 transition-all duration-300">
      <img
        src={place.url}
        alt={place.Name}
